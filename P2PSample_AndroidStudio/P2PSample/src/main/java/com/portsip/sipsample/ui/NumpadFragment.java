...
public class NumpadFragment extends Fragment implements AdapterView.OnItemSelectedListener, View.OnClickListener,
    ...
    public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
        switch (compoundButton.getId()){
            case R.id.conference:
                ...
                if(b){
                    application.mEngine.createVideoConference(null,320,240,false);
